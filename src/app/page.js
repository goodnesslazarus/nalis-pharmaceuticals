      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        <nav className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-slate-200 bg-white px-6 py-4 shadow-lg shadow-slate-200/40">
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm font-medium text-slate-700">
            ...
            <a href="#about" className="transition hover:text-cyan-600">About Us</a>
            <a href="#contact" className="transition hover:text-cyan-600">Contact</a>
            <Link href="/Products/cart" className="inline-flex items-center rounded-full bg-cyan-600 px-4 py-2 text-sm font-semibold text-white shadow-md shadow-cyan-500/25 transition hover:bg-cyan-500">
        ...
        <section id="home" className="mt-10 grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div className="rounded-[32px] border border-slate-200 bg-white p-10 shadow-xl shadow-slate-200/60">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Link href="/Products" className="inline-flex items-center justify-center rounded-full bg-cyan-600 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-cyan-500/20 transition hover:bg-cyan-500">
                Browse Products
              </Link>
              <a href="#products" className="inline-flex items-center justify-center rounded-full border border-cyan-100 bg-cyan-50 px-8 py-4 text-base font-semibold text-cyan-700 transition hover:border-cyan-300 hover:bg-cyan-100">
                Explore Categories
              </a>
            </div>
          ...
          <div className="space-y-6">
            <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/50">
              <div className="mb-6 flex items-center justify-between">
                <p className="text-sm uppercase tracking-[0.3em] text-cyan-600">Featured catalog</p>
            ...
            <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/50">
              <p className="text-sm uppercase tracking-[0.3em] text-cyan-600">Cart readiness</p>
              ...
              <Link href="/Products/cart" className="mt-8 inline-flex items-center rounded-full bg-cyan-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-cyan-500">
                View Cart
              </Link>
            </div>
          </div>
        ...
        <section id="testimonials" className="mt-12 rounded-[36px] border border-slate-200 bg-white px-8 py-10 shadow-xl shadow-slate-200/50">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-sm uppercase tracking-[0.24em] text-cyan-600">Customer feedback</p>
        ...
        <section id="products" className="mt-12 rounded-[36px] border border-slate-200 bg-white px-8 py-10 shadow-xl shadow-slate-200/50">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm uppercase tracking-[0.24em] text-cyan-600">Shop by category</p>
            ...
            {[
              ...
              <div key={item.title} className="rounded-[32px] border border-slate-200 bg-slate-50 p-6 shadow-lg shadow-slate-200/40">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <Link href="/Products" className="inline-flex items-center justify-center rounded-full bg-cyan-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-cyan-500">
                    View Products
                  </Link>
                </div>
              </div>
        ...
        <section id="contact" className="mt-12 rounded-[32px] bg-white px-6 py-12 shadow-xl shadow-slate-200">
          <div className="grid gap-10 lg:grid-cols-3">
            ...
            <div className="rounded-[28px] border border-slate-200 bg-slate-50 p-6">
              ...
              <div className="mt-4 inline-flex rounded-3xl bg-cyan-100 px-4 py-3 text-sm font-semibold text-cyan-700">
              ...
              <div className="grid gap-8 sm:grid-cols-3">
                <div>
                  ...
                  <ul className="mt-4 space-y-3 text-sm text-slate-600">
                    <li><a href="#about" className="transition hover:text-cyan-600">About</a></li>
                    <li><Link href="/Products" className="transition hover:text-cyan-600">Products</Link></li>
                    <li><a href="#contact" className="transition hover:text-cyan-600">Contact</a></li>
                  </ul>
                </div>
                <div>
                  <p className="text-sm uppercase tracking-[0.24em] text-slate-500">Resources</p>
                  <ul className="mt-4 space-y-3 text-sm text-slate-600">
                    <li><Link href="/Products/cart" className="transition hover:text-cyan-600">View Cart</Link></li>
                    <li><a href="#products" className="transition hover:text-cyan-600">Catalog</a></li>
                    <li><a href="#home" className="transition hover:text-cyan-600">Top</a></li>
                  </ul>
                </div>
                <div>
                  ...
                  <div className="mt-4 space-y-3 text-sm text-slate-600">
                    ...
                    <p>WhatsApp: <a href="https://wa.me/2348147180296" target="_blank" rel="noreferrer" className="font-semibold text-cyan-600">Chat now</a></p>
